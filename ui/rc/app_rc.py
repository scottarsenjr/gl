...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("F:\\pyqt\\ui\\ui\\../resources/gl3.png"))
...
"}")
        ...
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/search-hover.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/search-hover.svg"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/search-hover.svg"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
"color: rgb(167, 167, 167);")
        ...
        self.frame_10.setMinimumSize(QtCore.QSize(200, 250))
        self.frame_10.setMaximumSize(QtCore.QSize(200, 250))
        self.frame_10.setStyleSheet("border: 1px solid rgb(232, 232, 232);\n"
"border-radius: 30px;")
...
"border: 1px solid rgba(255, 255, 255, 0);")
        ...
        self.frame_11.setMinimumSize(QtCore.QSize(0, 120))
        self.frame_11.setMaximumSize(QtCore.QSize(16777215, 120))
        self.frame_11.setStyleSheet("border: 1px solid rgb(232, 232, 232);\n"
"border-radius: 30px;")
        self.frame_11.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_11.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_11.setObjectName("frame_11")
        self.verticalLayout_8.addWidget(self.frame_11)
        self.open_calc = QtWidgets.QPushButton(self.frame_10)
        self.open_calc.setMinimumSize(QtCore.QSize(100, 43))
        self.open_calc.setMaximumSize(QtCore.QSize(100, 43))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.open_calc.setFont(font)
        self.open_calc.setStyleSheet("border-radius: 20px;")
        self.open_calc.setObjectName("open_calc")
        self.verticalLayout_8.addWidget(self.open_calc, 0, QtCore.Qt.AlignHCenter)
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.frame_10)
        self.frame_13 = QtWidgets.QFrame(self.frame_8)
        self.frame_13.setEnabled(True)
        self.frame_13.setMinimumSize(QtCore.QSize(200, 250))
        self.frame_13.setMaximumSize(QtCore.QSize(200, 250))
        self.frame_13.setStyleSheet("border: 1px solid rgb(232, 232, 232);\n"
"border-radius: 30px;")
...
"border: 1px solid rgba(255, 255, 255, 0);")
        ...
        self.frame_14.setStyleSheet("border: 1px solid rgb(232, 232, 232);\n"
"border-radius: 30px;")
        self.frame_14.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_14.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_14.setObjectName("frame_14")
        self.verticalLayout_10.addWidget(self.frame_14)
        self.open_calendar = QtWidgets.QPushButton(self.frame_13)
        self.open_calendar.setMinimumSize(QtCore.QSize(100, 43))
        self.open_calendar.setMaximumSize(QtCore.QSize(100, 43))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.open_calendar.setFont(font)
        self.open_calendar.setStyleSheet("border-radius: 20px;")
        self.open_calendar.setObjectName("open_calendar")
        self.verticalLayout_10.addWidget(self.open_calendar, 0, QtCore.Qt.AlignHCenter)
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.frame_13)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "My Apps"))
        self.label_2.setText(_translate("MainWindow", "Calculator"))
        self.open_calc.setText(_translate("MainWindow", "Open"))
        self.label_4.setText(_translate("MainWindow", "Calendar"))
        self.open_calendar.setText(_translate("MainWindow", "Open"))
